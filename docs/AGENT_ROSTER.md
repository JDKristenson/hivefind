...
- **Xavier** — Chief of Staff — Fleet commander, keeps trains on time
...
- **Galen** — Chief Health Officer — Biometrics, recovery, health correlation
- **Martha** — Keeper of the Realm — Household, maintenance, family presence
- **Marco** — Chief Travel Officer — Travel logistics, loyalty programs
- **Seneca** — Chief Learning Officer — Curriculum, focus protection
- **Iris** — Chief Knowledge Officer — Knowledge synthesis, retrieval

### Haze Gray Consulting (4)
- **Helena** — Business Development Manager — Lead generation, pipeline
- **Cicero** — Chief Persuasion Officer — Proposals, pitches, speaking
- **Dale** — Content Strategist — LinkedIn, newsletter, thought leadership
- **Hamilton** — Engagement Manager — Client delivery operations

### Puzzlehouse.com (3)
- **Ada** — Social Media Director — Social content across platforms
- **Franklin** — Store Operations Manager — Shopify ops, inventory, compliance
- **Clara** — Customer Service Representative — Support, returns, complaints
...
```
           ...
           (Operations)        (Accountability)    (Communications)
                 │                   │                   │
    ┌────────────┼────────────┐      │                   │
    │            │            │      │                   │
...
|--------------|-------------|
| Hetty → Warren | Hetty reports to Warren; Warren owns finance, Hetty owns tax |
| Dale → Clare | Dale creates content; Clare coaches delivery |
