...
## KAM: execution substrate

**KAM** (added Phase 0, 2026-08-17) is the execution substrate for this fleet: one dispatch verb (`kam run`), one hash-chained run log in Supabase (`kam` schema), one human approval gate, and one identity
